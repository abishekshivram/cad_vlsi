...
# NO_OF_NETWORKS: Number of Ring Networks in L2
# ALL_NETWORK_NUM: The Network number associated with the Ring Network in L2
# ALL_NETWORK_ID: The hexadecimal network ID for each Ring L2 network
# ALL_NETWORK_DIM: The dimension of each Ring network in L2
def create_L2_Rings(NO_OF_NETWORKS, ALL_NETWORK_NUM, ALL_NETWORK_ID, ALL_NETWORK_DIM):
    d = {}

    # NO_OF_NETWORKS = 3
    # ALL_NETWORK_ID = [0, 1, 2]
    # ALL_NETWORK_DIM = [6, 4, 5]
